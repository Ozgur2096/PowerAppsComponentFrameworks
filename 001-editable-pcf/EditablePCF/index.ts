  ...
  implements ComponentFramework.StandardControl<IInputs, IOutputs>
{
  ...
  public init(
    ...
    message.innerText = `Project name ${
      this.isEditMode ? '' : context.parameters.Name.raw
    }`;
  ...
  public destroy(): void {
    ...
    this.container
      ...
      .removeEventListener('click', this.buttonClick);
  }
}
