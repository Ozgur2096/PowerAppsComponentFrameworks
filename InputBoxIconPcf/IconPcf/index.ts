  ...
  implements ComponentFramework.StandardControl<IInputs, IOutputs>
{
  ...
  public updateView(context: ComponentFramework.Context<IInputs>): void {
    ...
    // setting the max and min values for the control.
    this._valueMax = context.parameters.controlMaxValue.raw!;
    this.inputElement.setAttribute(
      'max',
      context.parameters.controlMaxValue.raw!.toString()
    );
    this._valueMin = context.parameters.controlMinValue.raw!;
    this.inputElement.setAttribute(
      'min',
      context.parameters.controlMinValue.raw!.toString()
    );
  ...
  //   refreshData function as the event handler
